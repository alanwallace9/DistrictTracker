...
const ADMIN_ALLOWED_ROLES = ['super_admin', 'district_admin'];
...
function AdminLayoutInner({
  ...
  // Tenant selector: On demo, hide when impersonating non-super_admin. On production, always show for super_admin.
  ...
  useEffect(() => {
    async function loadRole() {
      ...
      try {
        ...
        console.error('[Admin Layout] Error fetching user profile:', error);
  ...
  useEffect(() => {
    ...
    if (ADMIN_ALLOWED_ROLES.includes(effectiveRole)) {
      setIsAuthorized(true);
    } else {
      console.log('[Admin Layout] Redirecting - effective role not authorized:', effectiveRole);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden nav:flex items-center gap-4">
              ...
              {/* On demo: hide when impersonating non-super_admin. On production: always show for super_admin */}
        ...
        <div className="flex gap-8 items-start relative">
          ...
          `}>
            ...
            <nav className="space-y-2">
              {navItems
                .filter((item) => !item.masterAdminOnly || effectiveRole === 'super_admin')
                .map((item) => {
            ...
            <div className="nav:hidden mt-6 pt-6 border-t border-slate-200 space-y-3">
              ...
              {/* Tenant Selector - hidden when impersonating on demo */}
              {showTenantSelector && tenants.length > 1 && !tenantsLoading && selectedTenantId && (
              ...
              <Link href="/trespass" onClick={closeSidebar}>
                <Button
                  variant="outline"
                  size="sm"
